...
public class DataDummy {
    ...
    public static ArrayList<DeskripsiEntity> generateDummymovie() {
        ...
        movie.add(new DeskripsiEntity("420818",
        ...
        movie.add(new DeskripsiEntity("429617",
        ...
        movie.add(new DeskripsiEntity("399579",
        ...
        movie.add(new DeskripsiEntity("566555",
        ...
        movie.add(new DeskripsiEntity("287947",
        ...
        movie.add(new DeskripsiEntity("301528",
        ...
        movie.add(new DeskripsiEntity("66510",
        ...
        movie.add(new DeskripsiEntity("458156",
        ...
        movie.add(new DeskripsiEntity("299537",
        ...
        movie.add(new DeskripsiEntity("299534",
    ...
    public static ArrayList<DeskripsiEntity> generateDummytv() {

        ArrayList<DeskripsiEntity> tv = new ArrayList<>();
        String baseImageURL = "https://image.tmdb.org/t/p/w500";

        tv.add(new DeskripsiEntity("11634",
                ...
                "2006-05-14"));
        tv.add(new DeskripsiEntity("71446",
        ...
        tv.add(new DeskripsiEntity("12609",
                ...
                "1986-02-26"));
        tv.add(new DeskripsiEntity("60735",
                ...
                "2014-10-07"));
        tv.add(new DeskripsiEntity("1412",
        ...
        tv.add(new DeskripsiEntity("86034",
                ...
                "2019-07-08"));
        tv.add(new DeskripsiEntity("86816",
        ...
        tv.add(new DeskripsiEntity("86816",
                ...
                "...",
                ""));
        tv.add(new DeskripsiEntity("63926",
