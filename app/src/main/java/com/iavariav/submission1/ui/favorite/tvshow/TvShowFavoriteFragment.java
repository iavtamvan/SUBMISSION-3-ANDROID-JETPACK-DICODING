...
import com.iavariav.submission1.ui.favorite.movie.MovieFavoritePagedAdapter;
import com.iavariav.submission1.ui.favorite.movie.MovieFavoriteViewModel;
 ...
 */
public class TvShowFavoriteFragment extends Fragment implements FavoriteFragmentCallback {
    private TvShowFavoritePagedAdapter adapter;
...
//            viewModel = ViewModelProviders.of(this).get(BookmarkViewModel.class);
            ...
            adapter = new TvShowFavoritePagedAdapter(this);
    ...
    private ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
        ...
        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
            if (getView() != null) {
                ...
                TvShowEntity courseEntity = adapter.getItemById(swipedPosition);
